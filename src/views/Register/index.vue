<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="controls">
        <input name="m1" type="checkbox" v-model="checked" @change="!checked">
...
export default {
  ...
  methods: {
    ...
    async completeRegister() {
      const { phone, code, password, password1, checked } = this;
      try {
        (phone && code && password == password1 && password && checked==true) && await this.$store.dispatch('userRegister', {
          phone: phone,
          code: code,
          password: password
        });
